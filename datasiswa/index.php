...
<body>
    <form action="" method="post">
        ...
        <button type="submit" value="kirim"><a href="sesion1.php">CETAK</a></button>
        <button type="submit" value="reset" name="reset"><a href="sesion2.php">HAPUS DATA</a></button>
...
if(isset($_GET['hapus'])) {
    ...
    header('Location: http://localhost/projectoop/datasiswa/');
    exit;
}
